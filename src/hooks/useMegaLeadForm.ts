...
/**
 * useMegaLeadForm — QRC HVAC LP form submission hook.
 * CUSTOMER_ID is the real QRC HVAC ID from Atlas task. SITE_ID is a placeholder
 * and gets swapped after Mega Admin registration (landing-page-deploy Stage 2).
 */
  ...
  const submit = useCallback(
    async (formData: Record<string, unknown>): Promise<SubmissionResponse> => {
      ...
      const payload: SubmissionPayload = {
        ...
        source_provider: options.sourceProvider ?? "qrc-hvac-landing",
        form_data: formData,
